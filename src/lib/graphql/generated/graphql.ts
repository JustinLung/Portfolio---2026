...
/** Connection between the PostMeta_Fields type and the ContentNode type */
...
/** The &quot;BlogPostFields&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type BlogPostFields = AcfFieldGroup &
	AcfFieldGroupFields &
	BlogPostFields_Fields & {
		__typename?: 'BlogPostFields';
		/** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;BlogPostFields&quot; Field Group */
...
/** Interface representing fields of the ACF &quot;BlogPostFields&quot; Field Group */
export type BlogPostFields_Fields = {
	/** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;BlogPostFields&quot; Field Group */
	excerpt?: Maybe<Scalars['String']['output']>;
	/**
	 * The name of the field group
...
export type Category = DatabaseIdentifier &
	...
	UniformResourceIdentifiable & {
		...
		/** Connection between the Category type and the work type */
		works?: Maybe<CategoryToWorkConnection>;
	};
...
/** A taxonomy term that classifies content. Categories support hierarchy and can be used to create a nested structure. */
export type CategoryWorksArgs = {
	after?: InputMaybe<Scalars['String']['input']>;
	before?: InputMaybe<Scalars['String']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
	where?: InputMaybe<CategoryToWorkConnectionWhereArgs>;
};
...
/** Connection between the Category type and the work type */
export type CategoryToWorkConnection = Connection &
	WorkConnection & {
		__typename?: 'CategoryToWorkConnection';
		/** Edges for the CategoryToWorkConnection connection */
		edges: Array<CategoryToWorkConnectionEdge>;
		/** The nodes of the connection, without the edges */
		nodes: Array<Work>;
		/** Information about pagination in a connection. */
		pageInfo: CategoryToWorkConnectionPageInfo;
	};

/** An edge in a connection */
export type CategoryToWorkConnectionEdge = Edge &
	WorkConnectionEdge & {
		__typename?: 'CategoryToWorkConnectionEdge';
		/** A cursor for use in pagination */
		cursor?: Maybe<Scalars['String']['output']>;
		/** The item at the end of the edge */
		node: Work;
...
/** Pagination metadata specific to &quot;CategoryToWorkConnection&quot; collections. Provides cursors and flags for navigating through sets of CategoryToWorkConnection Nodes. */
export type CategoryToWorkConnectionPageInfo = PageInfo &
	WpPageInfo &
	WorkConnectionPageInfo & {
		__typename?: 'CategoryToWorkConnectionPageInfo';
		/** When paginating forwards, the cursor to continue. */
		endCursor?: Maybe<Scalars['String']['output']>;
		/** When paginating forwards, are there more items? */
		hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the CategoryToWorkConnection connection */
export type CategoryToWorkConnectionWhereArgs = {
	/** Category ID */
	categoryId?: InputMaybe<Scalars['Int']['input']>;
	/** Array of category IDs, used to display objects from one category OR another */
	categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']['input']>>>;
...
export enum ContentTemplateEnum {
	...
	PageNoTitleBlockTemplate = 'PAGE_NO_TITLE_BLOCK_TEMPLATE'
}
...
/** Input for the createExperience mutation. */
...
/** The payload for the createExperience mutation. */
...
export type CreateWorkInput = {
	/** Set connections between the work and categories */
	categories?: InputMaybe<WorkCategoriesInput>;
	/** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
	clientMutationId?: InputMaybe<Scalars['String']['input']>;
	/** The content of the object */
	content?: InputMaybe<Scalars['String']['input']>;
...
/** Input for the deleteExperience mutation. */
...
/** The payload for the deleteExperience mutation. */
...
/** The experience type */
export type Experience = ContentNode &
	DatabaseIdentifier &
	MenuItemLinkable &
	Node &
	NodeWithTemplate &
	...
	Previewable &
	UniformResourceIdentifiable &
	WithAcfExperienceFields & {
		__typename?: 'Experience';
		/**
		 * The ancestors of the content node.
		 * @deprecated This content type is not hierarchical and typically will not have ancestors
		 */
		ancestors?: Maybe<ExperienceToExperienceConnection>;
		/** Connection between the ContentNode type and the ContentType type */
		contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
		/** The name of the Content Type the node belongs to */
		contentTypeName: Scalars['String']['output'];
		...
		/** Connection between the ContentNode type and the EnqueuedStylesheet type */
		enqueuedStylesheets?: Maybe<ContentNodeToEnqueuedStylesheetConnection>;
		/** Fields of the ExperienceFields ACF Field Group */
		experienceFields?: Maybe<ExperienceFields>;
		/**
		 * The id field matches the WP_Post-&gt;ID field.
		...
		/** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
		guid?: Maybe<Scalars['String']['output']>;
		/** Whether the experience object is password protected. */
		hasPassword?: Maybe<Scalars['Boolean']['output']>;
		/** The globally unique identifier of the experience object. */
		id: Scalars['ID']['output'];
		/** Whether the node is a Comment */
		isComment: Scalars['Boolean']['output'];
		/** Whether the node is a Content Node */
		 ...
		 */
		parent?: Maybe<ExperienceToParentConnectionEdge>;
		/** The password for the experience object. */
		password?: Maybe<Scalars['String']['output']>;
		/** Connection between the experience type and the experience type */
		preview?: Maybe<ExperienceToPreviewConnectionEdge>;
		/** The database id of the preview node */
		previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
		/** Whether the object is a node in the preview state */
		previewRevisionId?: Maybe<Scalars['ID']['output']>;
...
/** The experience type */
export type ExperienceAncestorsArgs = {
	after?: InputMaybe<Scalars['String']['input']>;
	before?: InputMaybe<Scalars['String']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
...
/** The experience type */
export type ExperienceEnqueuedScriptsArgs = {
	after?: InputMaybe<Scalars['String']['input']>;
	before?: InputMaybe<Scalars['String']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
...
/** The experience type */
export type ExperienceEnqueuedStylesheetsArgs = {
	after?: InputMaybe<Scalars['String']['input']>;
	before?: InputMaybe<Scalars['String']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
...
/** A paginated collection of experience Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of experience Nodes */
export type ExperienceConnection = {
	/** A list of edges (relational context) between RootQuery and connected experience Nodes */
	edges: Array<ExperienceConnectionEdge>;
	/** A list of connected experience Nodes */
	nodes: Array<Experience>;
	/** Information about pagination in a connection. */
	pageInfo: ExperienceConnectionPageInfo;
};

/** Represents a connection to a experience. Contains both the experience Node and metadata about the relationship. */
export type ExperienceConnectionEdge = {
	/** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
	cursor?: Maybe<Scalars['String']['output']>;
	/** The connected experience Node */
	node: Experience;
};

/** Pagination metadata specific to &quot;ExperienceConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;ExperienceConnectionEdge&quot; Nodes. */
export type ExperienceConnectionPageInfo = {
	/** When paginating forwards, the cursor to continue. */
	endCursor?: Maybe<Scalars['String']['output']>;
	/** When paginating forwards, are there more items? */
	hasNextPage: Scalars['Boolean']['output'];
...
/** The &quot;ExperienceFields&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type ExperienceFields = AcfFieldGroup &
	AcfFieldGroupFields &
	ExperienceFields_Fields & {
		__typename?: 'ExperienceFields';
		/** Field of the &quot;true_false&quot; Field Type added to the schema as part of the &quot;ExperienceFields&quot; Field Group */
		currentyear?: Maybe<Scalars['Boolean']['output']>;
		/** Field of the &quot;number&quot; Field Type added to the schema as part of the &quot;ExperienceFields&quot; Field Group */
		 ...
		 */
		fieldGroupName?: Maybe<Scalars['String']['output']>;
		/** Field of the &quot;url&quot; Field Type added to the schema as part of the &quot;ExperienceFields&quot; Field Group */
		link?: Maybe<Scalars['String']['output']>;
		/** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;ExperienceFields&quot; Field Group */
		role?: Maybe<Scalars['String']['output']>;
		/** Field of the &quot;number&quot; Field Type added to the schema as part of the &quot;ExperienceFields&quot; Field Group */
		startyear?: Maybe<Scalars['Float']['output']>;
	};

/** Interface representing fields of the ACF &quot;ExperienceFields&quot; Field Group */
export type ExperienceFields_Fields = {
	/** Field of the &quot;true_false&quot; Field Type added to the schema as part of the &quot;ExperienceFields&quot; Field Group */
	currentyear?: Maybe<Scalars['Boolean']['output']>;
	/** Field of the &quot;number&quot; Field Type added to the schema as part of the &quot;ExperienceFields&quot; Field Group */
	endYear?: Maybe<Scalars['Float']['output']>;
...
/** Identifier types for retrieving a specific Experience. Specifies which unique attribute is used to find an exact Experience. */
export enum ExperienceIdType {
	/** Identify a resource by the Database ID. */
	DatabaseId = 'DATABASE_ID',
	/** Identify a resource by the (hashed) Global ID. */
	Id = 'ID',
...
/** Connection between the experience type and the experience type */
export type ExperienceToExperienceConnection = Connection &
	ExperienceConnection & {
		__typename?: 'ExperienceToExperienceConnection';
		/** Edges for the ExperienceToExperienceConnection connection */
		edges: Array<ExperienceToExperienceConnectionEdge>;
		/** The nodes of the connection, without the edges */
		nodes: Array<Experience>;
		/** Information about pagination in a connection. */
		pageInfo: ExperienceToExperienceConnectionPageInfo;
	};

/** An edge in a connection */
export type ExperienceToExperienceConnectionEdge = Edge &
	ExperienceConnectionEdge & {
		__typename?: 'ExperienceToExperienceConnectionEdge';
		/** A cursor for use in pagination */
		cursor?: Maybe<Scalars['String']['output']>;
		/** The item at the end of the edge */
		node: Experience;
...
/** Pagination metadata specific to &quot;ExperienceToExperienceConnection&quot; collections. Provides cursors and flags for navigating through sets of ExperienceToExperienceConnection Nodes. */
export type ExperienceToExperienceConnectionPageInfo = ExperienceConnectionPageInfo &
	PageInfo &
	WpPageInfo & {
		__typename?: 'ExperienceToExperienceConnectionPageInfo';
		/** When paginating forwards, the cursor to continue. */
		endCursor?: Maybe<Scalars['String']['output']>;
		/** When paginating forwards, are there more items? */
		hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the experience type and the experience type */
export type ExperienceToParentConnectionEdge = Edge &
	ExperienceConnectionEdge &
	OneToOneConnection & {
		__typename?: 'ExperienceToParentConnectionEdge';
		/** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
		cursor?: Maybe<Scalars['String']['output']>;
		/** The node of the connection, without the edges */
		node: Experience;
...
/** Connection between the experience type and the experience type */
export type ExperienceToPreviewConnectionEdge = Edge &
	ExperienceConnectionEdge &
	OneToOneConnection & {
		__typename?: 'ExperienceToPreviewConnectionEdge';
		/** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
		cursor?: Maybe<Scalars['String']['output']>;
		/** The node of the connection, without the edges */
		node: Experience;
...
/** The &quot;HomeFields&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type HomeFields = AcfFieldGroup &
	AcfFieldGroupFields &
	HomeFields_Fields & {
...
export type MenuItemObjectUnion = Category | Experience | Page | Post | PostFormat | Tag | Work;
...
export type Post = ContentNode &
	...
	WithAcfPostMeta & {
		...
		/** The globally unique identifier of the author of the node */
		authorId?: Maybe<Scalars['ID']['output']>;
		/** Fields of the BlogPostFields ACF Field Group */
		blogPostFields?: Maybe<BlogPostFields>;
		...
		/** Fields of the PostMeta ACF Field Group */
...
/** The &quot;PostMeta&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PostMeta = AcfFieldGroup &
	AcfFieldGroupFields &
	PostMeta_Fields & {
		__typename?: 'PostMeta';
		/**
		 ...
		 */
		fieldGroupName?: Maybe<Scalars['String']['output']>;
		/** Field of the &quot;relationship&quot; Field Type added to the schema as part of the &quot;PostMeta&quot; Field Group */
		relatedWorks?: Maybe<AcfContentNodeConnection>;
	};

/** The &quot;PostMeta&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type PostMetaRelatedWorksArgs = {
	after?: InputMaybe<Scalars['String']['input']>;
	before?: InputMaybe<Scalars['String']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
...
/** Interface representing fields of the ACF &quot;PostMeta&quot; Field Group */
export type PostMeta_Fields = {
	/**
	 * The name of the field group
	 * @deprecated Use __typename instead
	 */
...
/** Interface representing fields of the ACF &quot;PostMeta&quot; Field Group */
export type PostMeta_FieldsRelatedWorksArgs = {
	after?: InputMaybe<Scalars['String']['input']>;
	before?: InputMaybe<Scalars['String']['input']>;
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
...
/** The root mutation */
export type RootMutationDeleteExperienceArgs = {
...
/** The root mutation */
export type RootMutationUpdateExperienceArgs = {
...
export type RootQuery = {
	...
	/** An object of the experience Type.  */
	experience?: Maybe<Experience>;
	/**
	 * A experience object
	 * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
	 */
	experienceBy?: Maybe<Experience>;
	/** Connection between the RootQuery type and the experience type */
	experiences?: Maybe<RootQueryToExperienceConnection>;
...
export type RootQueryExperienceArgs = {
	asPreview?: InputMaybe<Scalars['Boolean']['input']>;
	id: Scalars['ID']['input'];
	idType?: InputMaybe<ExperienceIdType>;
};

/** The root entry point into the Graph */
export type RootQueryExperienceByArgs = {
...
export type RootQueryExperiencesArgs = {
	...
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
	where?: InputMaybe<RootQueryToExperienceConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the experience type */
export type RootQueryToExperienceConnection = Connection &
	ExperienceConnection & {
		__typename?: 'RootQueryToExperienceConnection';
		/** Edges for the RootQueryToExperienceConnection connection */
		edges: Array<RootQueryToExperienceConnectionEdge>;
		/** The nodes of the connection, without the edges */
		nodes: Array<Experience>;
		/** Information about pagination in a connection. */
		pageInfo: RootQueryToExperienceConnectionPageInfo;
	};

/** An edge in a connection */
export type RootQueryToExperienceConnectionEdge = Edge &
	ExperienceConnectionEdge & {
		__typename?: 'RootQueryToExperienceConnectionEdge';
		/** A cursor for use in pagination */
		cursor?: Maybe<Scalars['String']['output']>;
		/** The item at the end of the edge */
		node: Experience;
...
/** Pagination metadata specific to &quot;RootQueryToExperienceConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToExperienceConnection Nodes. */
export type RootQueryToExperienceConnectionPageInfo = ExperienceConnectionPageInfo &
	PageInfo &
	WpPageInfo & {
		__typename?: 'RootQueryToExperienceConnectionPageInfo';
		/** When paginating forwards, the cursor to continue. */
		endCursor?: Maybe<Scalars['String']['output']>;
		/** When paginating forwards, are there more items? */
		hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToExperienceConnection connection */
export type RootQueryToExperienceConnectionWhereArgs = {
	/** Filter the connection based on dates */
	dateQuery?: InputMaybe<DateQueryInput>;
	/** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
	hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the RootQuery type and the work type */
export type RootQueryToWorkConnection = Connection &
	WorkConnection & {
...
/** An edge in a connection */
export type RootQueryToWorkConnectionEdge = Edge &
	WorkConnectionEdge & {
...
/** Pagination metadata specific to &quot;RootQueryToWorkConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToWorkConnection Nodes. */
export type RootQueryToWorkConnectionPageInfo = PageInfo &
	WpPageInfo &
	WorkConnectionPageInfo & {
...
/** Input for the updateExperience mutation. */
export type UpdateExperienceInput = {
	/** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
	clientMutationId?: InputMaybe<Scalars['String']['input']>;
	/** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
	date?: InputMaybe<Scalars['String']['input']>;
	/** The ID of the experience object */
	id: Scalars['ID']['input'];
	/** Override the edit lock when another user is editing the post */
	ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
	/** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateExperience mutation. */
...
/** Provides access to fields of the &quot;BlogPostFields&quot; ACF Field Group via the &quot;blogPostFields&quot; field */
export type WithAcfBlogPostFields = {
	/** Fields of the BlogPostFields ACF Field Group */
	blogPostFields?: Maybe<BlogPostFields>;
};

/** Provides access to fields of the &quot;ExperienceFields&quot; ACF Field Group via the &quot;experienceFields&quot; field */
export type WithAcfExperienceFields = {
	/** Fields of the ExperienceFields ACF Field Group */
	experienceFields?: Maybe<ExperienceFields>;
};

/** Provides access to fields of the &quot;HomeFields&quot; ACF Field Group via the &quot;homeFields&quot; field */
export type WithAcfHomeFields = {
	/** Fields of the HomeFields ACF Field Group */
	homeFields?: Maybe<HomeFields>;
};

/** Provides access to fields of the &quot;PostMeta&quot; ACF Field Group via the &quot;postMeta&quot; field */
export type WithAcfPostMeta = {
	/** Fields of the PostMeta ACF Field Group */
	postMeta?: Maybe<PostMeta>;
};

/** Provides access to fields of the &quot;WorkFields&quot; ACF Field Group via the &quot;workFields&quot; field */
export type WithAcfWorkFields = {
	/** Fields of the WorkFields ACF Field Group */
	workFields?: Maybe<WorkFields>;
};

/** The work type */
export type Work = ContentNode &
	DatabaseIdentifier &
	MenuItemLinkable &
	Node &
	NodeWithContentEditor &
	...
	WithAcfWorkFields & {
		 ...
		 * @deprecated This content type is not hierarchical and typically will not have ancestors
		 */
		ancestors?: Maybe<WorkToWorkConnection>;
		/** Connection between the Work type and the category type */
		categories?: Maybe<WorkToCategoryConnection>;
		/** The content of the post. */
		content?: Maybe<Scalars['String']['output']>;
		/** Connection between the ContentNode type and the ContentType type */
		contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
		...
		/** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
		guid?: Maybe<Scalars['String']['output']>;
		/** Whether the work object is password protected. */
		hasPassword?: Maybe<Scalars['Boolean']['output']>;
		 ...
		 * @deprecated This content type is not hierarchical and typically will not have a parent
		 */
		parent?: Maybe<WorkToParentConnectionEdge>;
		/** The password for the work object. */
		password?: Maybe<Scalars['String']['output']>;
...
export type WorkCategoriesArgs = {
	...
	first?: InputMaybe<Scalars['Int']['input']>;
	last?: InputMaybe<Scalars['Int']['input']>;
	where?: InputMaybe<WorkToCategoryConnectionWhereArgs>;
};
...
/** Set relationships between the work to categories */
export type WorkCategoriesInput = {
	/** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
	append?: InputMaybe<Scalars['Boolean']['input']>;
	/** The input list of items to set. */
	nodes?: InputMaybe<Array<InputMaybe<WorkCategoriesNodeInput>>>;
};

/** List of categories to connect the work to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type WorkCategoriesNodeInput = {
	/** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
	description?: InputMaybe<Scalars['String']['input']>;
	/** The ID of the category. If present, this will be used to connect to the work. If no existing category exists with this ID, no connection will be made. */
	id?: InputMaybe<Scalars['ID']['input']>;
	/** The name of the category. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
	name?: InputMaybe<Scalars['String']['input']>;
	/** The slug of the category. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** A paginated collection of work Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of work Nodes */
...
/** Represents a connection to a work. Contains both the work Node and metadata about the relationship. */
...
/** Pagination metadata specific to &quot;WorkConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;WorkConnectionEdge&quot; Nodes. */
...
/** The &quot;WorkFields&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type WorkFields = AcfFieldGroup &
	AcfFieldGroupFields &
	WorkFields_Fields & {
		__typename?: 'WorkFields';
		/** Field of the &quot;select&quot; Field Type added to the schema as part of the &quot;WorkFields&quot; Field Group */
		at?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
		/** Field of the &quot;text&quot; Field Type added to the schema as part of the &quot;WorkFields&quot; Field Group */
		excerpt?: Maybe<Scalars['String']['output']>;
		/**
		 * The name of the field group
		 * @deprecated Use __typename instead
...
/** Connection between the Work type and the category type */
export type WorkToCategoryConnection = CategoryConnection &
	Connection & {
		__typename?: 'WorkToCategoryConnection';
		/** Edges for the WorkToCategoryConnection connection */
		edges: Array<WorkToCategoryConnectionEdge>;
		/** The nodes of the connection, without the edges */
		nodes: Array<Category>;
		/** Information about pagination in a connection. */
		pageInfo: WorkToCategoryConnectionPageInfo;
	};

/** An edge in a connection */
export type WorkToCategoryConnectionEdge = CategoryConnectionEdge &
	Edge & {
		__typename?: 'WorkToCategoryConnectionEdge';
		/** A cursor for use in pagination */
		cursor?: Maybe<Scalars['String']['output']>;
		/** The item at the end of the edge */
		node: Category;
...
/** Pagination metadata specific to &quot;WorkToCategoryConnection&quot; collections. Provides cursors and flags for navigating through sets of WorkToCategoryConnection Nodes. */
export type WorkToCategoryConnectionPageInfo = CategoryConnectionPageInfo &
	PageInfo &
	WpPageInfo & {
		__typename?: 'WorkToCategoryConnectionPageInfo';
		/** When paginating forwards, the cursor to continue. */
		endCursor?: Maybe<Scalars['String']['output']>;
		/** When paginating forwards, are there more items? */
		hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the WorkToCategoryConnection connection */
export type WorkToCategoryConnectionWhereArgs = {
	/** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
	cacheDomain?: InputMaybe<Scalars['String']['input']>;
	/** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
	childOf?: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the work type and the work type */
export type WorkToParentConnectionEdge = Edge &
	OneToOneConnection &
	WorkConnectionEdge & {
		__typename?: 'WorkToParentConnectionEdge';
		/** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
		cursor?: Maybe<Scalars['String']['output']>;
		/** The node of the connection, without the edges */
		node: Work;
...
/** Connection between the work type and the work type */
export type WorkToPreviewConnectionEdge = Edge &
	OneToOneConnection &
	WorkConnectionEdge & {
...
/** Connection between the Work type and the TermNode type */
export type WorkToTermNodeConnection = Connection &
	TermNodeConnection & {
...
/** An edge in a connection */
export type WorkToTermNodeConnectionEdge = Edge &
	TermNodeConnectionEdge & {
...
/** Pagination metadata specific to &quot;WorkToTermNodeConnection&quot; collections. Provides cursors and flags for navigating through sets of WorkToTermNodeConnection Nodes. */
export type WorkToTermNodeConnectionPageInfo = PageInfo &
	TermNodeConnectionPageInfo &
	WpPageInfo & {
...
/** Connection between the work type and the work type */
export type WorkToWorkConnection = Connection &
	WorkConnection & {
		__typename?: 'WorkToWorkConnection';
		/** Edges for the WorkToWorkConnection connection */
		edges: Array<WorkToWorkConnectionEdge>;
		/** The nodes of the connection, without the edges */
		nodes: Array<Work>;
		/** Information about pagination in a connection. */
		pageInfo: WorkToWorkConnectionPageInfo;
	};

/** An edge in a connection */
export type WorkToWorkConnectionEdge = Edge &
	WorkConnectionEdge & {
		__typename?: 'WorkToWorkConnectionEdge';
		/** A cursor for use in pagination */
		cursor?: Maybe<Scalars['String']['output']>;
		/** The item at the end of the edge */
		node: Work;
...
/** Pagination metadata specific to &quot;WorkToWorkConnection&quot; collections. Provides cursors and flags for navigating through sets of WorkToWorkConnection Nodes. */
export type WorkToWorkConnectionPageInfo = PageInfo &
	WpPageInfo &
	WorkConnectionPageInfo & {
		__typename?: 'WorkToWorkConnectionPageInfo';
		/** When paginating forwards, the cursor to continue. */
		endCursor?: Maybe<Scalars['String']['output']>;
		/** When paginating forwards, are there more items? */
		hasNextPage: Scalars['Boolean']['output'];
...
export type TermsOfServiceFieldsFragment = {
	id: string;
	title: string | null;
	content: string | null;
	uri: string | null;
...
export type GetTermsOfServicePageQueryVariables = Exact<{ [key: string]: never }>;

export type GetTermsOfServicePageQuery = {
	page: {
		id: string;
		title: string | null;
		content: string | null;
...
export const ExperienceFieldsFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
			name: { kind: 'Name', value: 'ExperienceFields' },
			typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'Experience' } },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					...
					{ kind: 'Field', name: { kind: 'Name', value: 'uri' } },
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{ kind: 'Field', name: { kind: 'Name', value: 'currentyear' } }
							]
						}
					}
				]
					...
					},
					{
						...
						selectionSet: {
							...
							selections: [
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'relatedWorks' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{
...
export const PrivacyPolicyFieldsFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
...
} as unknown as DocumentNode<PrivacyPolicyFieldsFragment, unknown>;
export const TermsOfServiceFieldsFragmentDoc = {
	kind: 'Document',
	definitions: [
		{
			kind: 'FragmentDefinition',
...
} as unknown as DocumentNode<TermsOfServiceFieldsFragment, unknown>;
...
} as unknown as DocumentNode<WorkFieldsFragment, unknown>;
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								...
								{
									kind: 'Field',
									name: { kind: 'Name', value: 'aboutImages' },
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'Field', name: { kind: 'Name', value: 'id' } },
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'GetExperiences' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
							...
							selections: [
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'ExperienceFields' } }
										]
									}
								}
							]
	...
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'GetPrivacyPolicyPage' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
						...
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'id' },
								value: { kind: 'StringValue', value: 'privacy-policy', block: false }
							},
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'idType' },
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'PrivacyPolicyFields' } }
							]
						}
					}
				]
...
} as unknown as DocumentNode<GetPrivacyPolicyPageQuery, GetPrivacyPolicyPageQueryVariables>;
export const GetTermsOfServicePageDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'GetTermsOfServicePage' },
			selectionSet: {
				kind: 'SelectionSet',
				selections: [
					{
						...
						arguments: [
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'id' },
								value: { kind: 'StringValue', value: 'terms-of-service', block: false }
							},
							{
								kind: 'Argument',
								name: { kind: 'Name', value: 'idType' },
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [
								{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'TermsOfServiceFields' } }
							]
						}
					}
				]
...
} as unknown as DocumentNode<GetTermsOfServicePageQuery, GetTermsOfServicePageQueryVariables>;
export const WorksDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
							...
							selections: [
								{
									...
									selectionSet: {
										kind: 'SelectionSet',
										selections: [
											{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'WorkFields' } }
										]
									}
								}
							]
...
} as unknown as DocumentNode<WorksQuery, WorksQueryVariables>;
				...
				selections: [
					{
						...
						selectionSet: {
							kind: 'SelectionSet',
							selections: [{ kind: 'FragmentSpread', name: { kind: 'Name', value: 'WorkFields' } }]
						}
					}
				]
			}
...
} as unknown as DocumentNode<WorkQuery, WorkQueryVariables>;
